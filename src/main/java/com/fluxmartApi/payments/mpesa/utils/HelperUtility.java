package com.fluxmartApi.payments.mpesa.utils;
...
public class HelperUtility {
    ...
    public static String toBase64String(String value) {
        ...
        return Base64.getEncoder().encodeToString(data);  // Use java.util.Base64
    }
...
//            encryptedPassword = Base64.getEncoder().encodeToString(cipherText).trim();  // Use java.util.Base64
